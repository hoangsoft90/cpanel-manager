 ...
 * For the full documentation, see http://go.cpanel.net/livephp.
 *
 ...
 * @version   Release: 2.1
 * @link      http://go.cpanel.net/livephp
 */
class CPANEL
{
    /**
    ...
    * note: modern themes only
     ...
     *
     * @link http://go.cpanel.net/PluginVars ExpVar Reference Chart
     ...
     * @see http://go.cpanel.net/maketext ## no extract maketext
     *
    ...
    */
    public function header( $title = '' ) {
        if ( !$this->_dom ) {
            $result = $this->uapi( 'Chrome', 'get_dom', array( 'page_title' => $title ) );
